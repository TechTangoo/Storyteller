...
const SidebarItem = () => {
    ...
    return (
        <div>
            <IconButton style={{ marginRight: 20, cursor: 'pointer' }} onClick={() => setOpen(true)}>
            ...
            >
                ...
                >
                    <List style={{ color: '#e9d5ff' }}>
                        <ListItem onClick={() => { setOpen(false); navigate('/'); }} disablePadding style={{ backgroundColor: window.location.pathname === "/" ? "#6b21a8" : "" }}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem onClick={() => { setOpen(false); navigate('/gener'); }} disablePadding style={{ backgroundColor: window.location.pathname === "/gener" ? "#6b21a8" : "" }}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem onClick={() => { setOpen(false); navigate('/create'); }} disablePadding style={{ backgroundColor: window.location.pathname === "/create" ? "#6b21a8" : "" }}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem onClick={() => { setOpen(false); navigate('/fav'); }} disablePadding style={{ backgroundColor: window.location.pathname === "/fav" ? "#6b21a8" : "" }}>
                            <ListItemButton>
                                <ListItemIcon>
                    ...
                    <List style={{ color: '#e9d5ff' }}>
                        ...
                        <ListItem onClick={() => { setOpen(false); navigate('/profile'); }} disablePadding style={{ backgroundColor: window.location.pathname === "/profile" ? "#6b21a8" : "" }}>
                            <ListItemButton>
                                <ListItemIcon>
                        ...
                        <ListItem onClick={() => { setOpen(false); navigate('/login'); sessionStorage.removeItem('token') }} disablePadding style={{}}>
                            <ListItemButton>
                                <ListItemIcon>
